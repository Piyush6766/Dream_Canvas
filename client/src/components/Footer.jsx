      ...
      <div className="max-w-7xl mx-auto px-4 py-14">
        ...
        >
          ...
          <div className="md:w-2/5 flex flex-col items-start">
            ...
            <p className={`text-sm leading-relaxed mt-2 max-w-sm ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
              Transform your imagination into high-quality AI visuals. Fast. Stunning. Limitless creativity for everyone.
            </p>
          </div>

          {/* Quick Links */}
          <div className="md:w-1/6">
            <h3 className={`text-sm font-semibold mb-2 ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}>QUICK LINKS</h3>
            <ul className={`space-y-1 text-sm ${darkMode ? 'text-gray-400' : 'text-gray-700'}`}>
              <li><Link to="#" className="hover:text-blue-500 transition">Home</Link></li>
              <li><Link to="#" className="hover:text-blue-500 transition">Gallery</Link></li>
              <li><Link to="#" className="hover:text-blue-500 transition">Pricing</Link></li>
            </ul>
          </div>

          {/* Support */}
          <div className="md:w-1/6">
            <h3 className={`text-sm font-semibold mb-2 ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}>SUPPORT</h3>
            <ul className={`space-y-1 text-sm ${darkMode ? 'text-gray-400' : 'text-gray-700'}`}>
              ...
              <li><Link to="#" className="hover:text-blue-500 transition">Terms & Conditions</Link></li>
            </ul>
          </div>

          {/* Newsletter */}
          <div className="md:w-1/4">
            <h3 className={`text-sm font-semibold mb-2 ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}>STAY UPDATED</h3>
            ...
            <form className="flex flex-col sm:flex-row items-center gap-3">
              <input
                ...
                className={`w-full sm:flex-1 px-4 py-2 text-sm rounded-md border ${darkMode
                  ? 'bg-neutral-700 text-white border-gray-600 placeholder-gray-400'
                  : 'bg-white border-gray-300 text-gray-800'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
              />
              <button
                type="submit"
        ...
        {/* Bottom Bar */}
        <div className={`text-center text-sm mt-10 pt-6 border-t ${darkMode ? 'text-gray-400 border-gray-700' : 'text-gray-500 border-gray-200'}`}>
